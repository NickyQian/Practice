...
public class BinarySearch {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(binarySearch.binarySearch(source1, 5, 0,
                source1.length - 1)); // return true
        System.out.println(binarySearch.binarySearch(source1, 4, 0,
                source1.length - 1)); // return false
        System.out.println(binarySearch.binarySearch(source2, 20, 0,
                source1.length - 1));// return true
        System.out.println(binarySearch.binarySearch(source2, 68, 0,
                source1.length - 1));// return true
    }

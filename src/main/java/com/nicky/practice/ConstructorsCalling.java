...
public class ConstructorsCalling extends Base {
    ...
    public ConstructorsCalling(int i) { // the super should be written in first
                                        // line.
        super(1); // if there's no super, it will call the default super();
        System.out
                .println("This is ConstructorsCalling Class's constructor with int i : "
                        + i);
    }
...
class Base {
    ...
    public Base(int i) {
        System.out
                .println("This is Base Class's constructor with int i : " + i);
    }
}
